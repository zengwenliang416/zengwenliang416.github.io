    ...
    <section id="papers" className="max-w-[1400px] mx-auto px-6 md:px-12 py-32">
      <RevealOnScroll>
        <h2 className="font-display text-[clamp(36px,5vw,56px)] font-bold text-text-primary mb-16">
          {t.publications.heading[0]} <span className="text-indigo">{t.publications.heading[1]}</span>
        </h2>
      </RevealOnScroll>
          ...
          return (
            <RevealOnScroll key={pub.title} delay={i * 0.1}>
              ...
              >
                ...
                <p className="text-text-secondary text-[15px] leading-relaxed mb-3">{tr?.desc ?? pub.title}</p>
